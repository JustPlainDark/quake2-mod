...
/*weapon_null aka fists gained from ModDB to create the melee functionality and have working fists*/

	{
	   ...
	   "misc/w_pkup.wav",
		NULL, 0,
	   "models/weapons/v_handgr/tris.md2", //The models stuff.(This is the grenade model)
